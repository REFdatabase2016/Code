...
def guardar():
    ...
    lista.append(n+"$"+p+"$"+c)
    escribirProducto()
    messagebox.showinfo("Guardar","Producto Guardado en el Inventario")
    nombre.set("")
    precio.set("")
    cantidad.set("")
    consultar()
...
def ventanaempl():
    ...
    abririnvt2=Button(ventanaempl, text="Abrir Inventario",font=("Calibri",17),command=invent2).place(x=200, y=150)
    ventanaempl.resizable(0,0)
